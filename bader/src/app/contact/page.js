...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#31124b] to-[#220d38]">
      <Head>
        <title>اتصل بنا | مشروع بادر</title>
        <meta name="description" content="تواصل مع مشروع بادر لإصلاح مشاكل الحي" />
      </Head>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        >
          <h1 className="text-5xl font-bold text-white mb-4 font-arabic">اتصل بنا</h1>
          <div className="flex justify-center">
            <motion.div 
              className="h-1 w-24 bg-[#fa9e1b] rounded-full"
              initial={{ width: 0 }}
              animate={{ width: 100 }}
              transition={{ duration: 1, delay: 0.5 }}
            />
          </div>
          <p className="text-gray-300 mt-6 max-w-2xl mx-auto text-xl font-arabic">
            نرحب بتواصلكم معنا في مشروع "بادر" لإصلاح مشاكل الحي. املأ النموذج أدناه وسنعود إليك في أقرب وقت ممكن.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-8 border border-b-neutral-800 border-opacity-100 shadow-xl">
              {isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-gray-300 font-arabic">سنتواصل معك قريباً</p>
                </motion.div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6 text-right">
                  <div>
                    <label className="block text-[#fa9e1b] mb-2 font-arabic">الاسم</label>
                    <input
                      type="text"
                      name="name"
                      value={formData.name}
                      ...
                      required
                      className="w-full px-4 py-3 rounded-lg bg-white bg-opacity-10 border border-b-neutral-800 border-opacity-100 text-white focus:outline-none focus:ring-2 focus:ring-[#fa9e1b] transition-all duration-300 text-right"
                      placeholder="أدخل اسمك الكامل"
                    />
                  </div>
                  
                  <div>
                    <label className="block text-[#fa9e1b] mb-2 font-arabic">البريد الإلكتروني</label>
                    <input
                      type="email"
                      name="email"
                  ...
                  <div>
                    <label className="block text-[#fa9e1b] mb-2 font-arabic">رقم الهاتف</label>
                    <input
                      type="tel"
                      name="phone"
                  ...
                  <div>
                    <label className="block text-[#fa9e1b] mb-2 font-arabic">الرسالة</label>
                    <textarea
                      name="message"
          ...
          >
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-white mb-6 font-arabic">معلومات التواصل</h2>
                <p className="text-gray-300 mb-8 text-lg font-arabic">
                  يمكنك التواصل معنا مباشرة من خلال النموذج أو باستخدام أي من وسائل الاتصال التالية:
                </p>
              </div>
              
              <motion.div 
                className="flex items-center gap-4 text-gray-200 transition-colors duration-300"
                whileHover={{ x: 5 }}
              >
                ...
                <div>
                  ...
                  <p className="text-lg">+966 12 345 6789</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="font-bold text-xl mb-1 font-arabic">البريد الإلكتروني</h3>
                  <p className="text-lg">info@badir-project.com</p>
                </div>
              </motion.div>
              ...
              <div className="pt-6">
                <h3 className="font-bold text-xl mb-4 text-white font-arabic">تابعنا على</h3>
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-4 font-arabic">موقعنا</h2>
            <p className="text-gray-300 max-w-2xl mx-auto text-lg font-arabic">
              يمكنك زيارتنا في مقر مشروع بادر لإصلاح مشاكل الحي
            </p>
          </div>
          
          <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-2xl p-4 border border-b-neutral-800 border-opacity-100 shadow-xl overflow-hidden h-96 relative">
            <div className="absolute inset-0 z-0 flex items-center justify-center">
              <div className="animate-pulse flex flex-col items-center justify-center">
                ...
                <p className="mt-2 text-white text-lg font-arabic">جاري تحميل الخريطة...</p>
              </div>
            </div>
            <Map />
          </div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-right">
              <h3 className="text-2xl font-bold text-white mb-2 font-arabic">هل لديك مشكلة في حيك؟</h3>
              <p className="text-gray-300 font-arabic">بادر بالإبلاغ عن المشكلة وسنعمل على حلها في أقرب وقت ممكن</p>
            </div>
            <motion.a 
              href="/report-issue" 
